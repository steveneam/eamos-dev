...
class WorkflowService:
    ...
    def create_run(self, payload: RunRequest) -> RunResponse:
        ...
        primary_variant = reports[0].extracted_case.variants[0] if (
            reports
            and getattr(reports[0].extracted_case, 'variants', None)
        ) else None
    ...
    def _build_report_payload(
        ...
        pubmed_articles_raw = pubmed_data.get('articles', []) if isinstance(pubmed_data, dict) else []
