...
async def upload_report(request: Request, file: UploadFile = File(...), report_kind: ReportKind = Form(default='test'), _current_user: AuthUser = Depends(require_authenticated_user)) -> ReportUploadResponse:
