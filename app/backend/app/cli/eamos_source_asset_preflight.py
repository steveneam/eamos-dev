...
_RENDER_RUNTIME_ENV_NAMES = (
    ...
    "PROTEIN_ANNOTATION_UNIPROT_FEATURES_ENABLED",
    "PROTEIN_ANNOTATION_UNIPROT_DAT_PATH",
    "PROTEIN_ANNOTATION_UNIPROT_FEATURE_INDEX_PATH",
    "PROTEIN_ANNOTATION_UNIPROT_SCAN_TIMEOUT_SECONDS",
)
