...
export const CRISPR_TIDE_SAMPLE: CrisprTideResult = {
  ...
  analysis_disclosure: {
    capability_id: 'crispr.frontend_tide_sample',
    claim: 'Display a non-operational frontend outcome sample.',
    execution: 'fixture',
    input_scope: 'frontend_sample_only',
    ...
    requirements: ['validated_tide_signal_decomposition'],
  },
  source_disclosure: {
  ...
  consensus_difference_fraction: null,
