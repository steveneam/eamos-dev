...
const SECTIONS: { h: string; p: string }[] = [
  {
    ...
    p: 'Eamos aggregates third-party genomic evidence (ClinVar, gnomAD, SpliceAI, VEP, PubMed and others) into a single report. It is provided for research and informational purposes only and is not a medical device. Output must not be used as the sole basis for any clinical or diagnostic decision.',
  },
  {
