...
| --- | --- | --- | --- | --- |
| [Eamos CRISPR Readiness Operator Tooling](./eamos-crispr-readiness-tooling.md) | Operator CLI + sanitized readiness workflow | 2026-06-12 01:46 +1000 - Codex | 2026-06-12 01:46 +1000 - Codex | `app/backend/app/services/crispr_design.py`, `app/backend/app/services/crispr_offtarget_index.py`, `app/backend/app/cli/eamos_crispr_score_preflight.py`, `app/backend/app/cli/eamos_crispr_offtarget_index.py` |
