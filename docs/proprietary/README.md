...
| [Eamos Migration Asset Manifest Verifier](./eamos-migration-manifest.md) | Operator CLI + checksum reconciliation service | 2026-07-16 08:41 +0000 - Codex | 2026-07-16 08:41 +0000 - Codex | `app/backend/app/services/migration_asset_manifest.py`, `app/backend/app/cli/eamos_migration_manifest.py` |
| [Local-First Source Model Workflows](./local-first-source-model-workflows.md) | Source-model workflow / local adapter pattern | 2026-05-27 22:11 +1000 - Codex | 2026-06-25 02:56 +1000 - Codex | `app/backend/app/services/{transcript_model,clinvar_local,dbsnp_local,repeatmasker_local,indexed_sources,duckdb_analytical}.py` |
...
| [Search Input AI Extractor + Lexicon](./search-input-ai.md) | Mock-first AI extraction service | 2026-05-21 23:09 +1000 - Codex | 2026-06-13 23:16 +1000 - Claude | `app/backend/app/services/search_input_ai.py`, `app/backend/app/fixtures/search_input_lexicon.json`, `app/backend/app/services/ai_gateway/structured.py` |
...
| [Eamos AI Gateway Evidence-Grounded Chat & Extraction](./eamos-ai-gateway.md) | AI orchestration — broker + evidence-only guard + literature RAG + structured extraction | 2026-06-13 23:16 +1000 - Claude | 2026-06-13 23:16 +1000 - Claude | `app/backend/app/services/ai_gateway/{engine,guard,retrieval,structured}.py`, `app/backend/app/services/chat_service.py`, `app/backend/app/cli/eamos_literature_embed_materialize.py` |
