...
| 4 | 08 May | DNA notation leads everywhere (c.cdna primary, p.protein muted below); plain language variant decoder (regex/template, offline, 7 cdna types, 3 protein types); all 4 backend tools gene-agnostic (ClinVar, VEP, SpliceAI, Franklin); project moved to E:\HSIL-2026 |
