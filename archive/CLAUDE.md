...
Retired session handoffs, superseded planning documents, and completed checklists. Read-only historical record — do not edit.
...
| --------- | ---- | ------------ |
| `06_deliverables/` | Hackathon submission checklist and deliverable record | Historical deliverable tracking |
| `99_archive/` | Further archived materials with explanatory README | - |
